const Login = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-slate-50 p-6">
      <div className="w-full max-w-md bg-white/90 backdrop-blur-sm border border-gray-200 rounded-2xl shadow-lg p-8">
        ...
        <form className="space-y-4">
          <div className="relative">
            <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400" aria-hidden>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <a className="text-emerald-600 hover:underline" href="#">Forgot password?</a>
          </div>
          ...
          <div className="mt-3 flex flex-col items-center gap-3">
            ...
            <button type="button" className="flex items-center gap-3 border rounded-lg px-3 py-2 hover:bg-slate-50 transition">
              <svg className="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                <circle cx="12" cy="12" r="10" fill="#4285F4" />
                <text x="12" y="16" textAnchor="middle" fontSize="12" fill="#fff" fontFamily="Arial, Helvetica, sans-serif">G</text>
              </svg>
              <span className="text-sm text-slate-700">Sign in with Google</span>
            </button>

            <p className="mt-2 text-center text-sm text-slate-500">Don't have an account? <a className="text-emerald-600 hover:underline" href="#">Sign up</a></p>
          </div>
        </form>
